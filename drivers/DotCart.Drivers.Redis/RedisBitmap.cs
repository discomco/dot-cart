...
public class RedisBitmap : RedisItem<byte[]>
{
    ...
    public new RedisBitmap WithTx(RedisTransactionDb redisDb)
    {
        return base.WithTx(redisDb) as RedisBitmap;
    }

    public new RedisBitmap WithBatch(BatchRedisDb batchRedisDb)
    {
        return base.WithBatch(batchRedisDb) as RedisBitmap;
    }
