...
public class RedisStoreT<TDbInfo, TDoc> : IRedisStoreT<TDoc>
    where TDoc : IState
{
    ...
    protected RedisStoreT(IRedisDbT<TDbInfo, TDoc> redisDb)
    {
        _redisDb = redisDb;
    }
    ...
    public static RedisStoreT<TDbInfo, TDoc> New(IRedisDbT<TDbInfo, TDoc> redisDb)
    {
        return new RedisStoreT<TDbInfo, TDoc>(redisDb);
    }
}