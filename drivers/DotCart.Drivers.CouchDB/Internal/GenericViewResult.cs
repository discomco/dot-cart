...
///     a CouchDocument.
/// </summary>
public class GenericViewResult : ViewResult
{
    /// <summary>
    ...
    {
        var list = new List<T>();
        foreach (var row in Rows()) list.Add(row["value"].Value<T>());
        return list;
    }
    ...
    /// </summary>
    /// <returns>List of documents found.</returns>
    public IEnumerable<JsonDocument> Documents()
    {
        return RetrieveDocuments<JsonDocument>("doc");
    }
    ...
    public IEnumerable<QueryDocument> RowDocuments()
    {
        return RowDocuments<QueryDocument>();
    }
