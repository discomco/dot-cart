...
namespace DotCart.Drivers.CouchDB.Internal.Linq;
...
public class CouchQueryProvider : IQueryProvider
{
    ...
    private readonly ICouchViewDefinitionT _definition;
    ...
    public CouchQueryProvider(ICouchDatabase db, ICouchViewDefinitionT definition)
    {
        _db = db;
    ...
    {
        if (!typeof(ViewResult).IsAssignableFrom(typeof(TResult)))
