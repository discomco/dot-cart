...
/// </summary>
public class ViewDefinitionT : ViewDefinitionB, IEquatable<ICouchViewDefinitionT>, ICouchViewDefinitionT
{
    /// <summary>
    ...
    public ViewDefinitionT(string name, DesignDocument doc) : base(name, doc)
    {
    }
    ...
    public ViewDefinitionT(string name, string map, string reduce, DesignDocument doc) : base(name, doc)
    {
        Map = map;
        Reduce = reduce;
    }
    ...
    public void ReadJson(JObject obj)
    {
        ...
        if (obj["reduce"] != null) Reduce = obj["reduce"].Value<string>();
    }
    ...
    public bool Equals(ICouchViewDefinitionT other)
    {
        return
            Name != null &&
