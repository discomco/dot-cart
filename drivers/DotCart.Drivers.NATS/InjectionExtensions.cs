...
{
    /// <summary>
    ///     Add NatsClient <see cref="IConnection" /> and <see cref="IEncodedConnection" /> to
    ///     <see cref="IServiceCollection" />,
    ///     Also adds <see cref="INatsClientConnectionFactory" /> abstract factory to ease creating new connection.
    /// </summary>
    /// <param name="services"><see cref="IServiceCollection" /> instance</param>
    /// <param name="configureOptions">
    ///     Configure the default options to be used when resolving NATS client connection via the
    ///     DI. When null the default configurations will be used.
    /// </param>
    /// <param name="connectionServiceLifeTime">
    ///     Configure the default lifetime for the connections resolved via the DI. Default
    ///     is Transient.
    /// </param>
    /// <returns>
    ///     <see cref="IServiceCollection" />
