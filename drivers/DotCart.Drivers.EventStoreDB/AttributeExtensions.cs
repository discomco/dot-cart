...
public static class AttributeExtensions
{
    ...
    {
        var atts = (GroupNameAttribute[])typeof(TEsSubscriber).GetCustomAttributes(typeof(GroupNameAttribute),
            true);
    ...
    {
        var atts = (StreamNameAttribute[])typeof(TEsSubscriber).GetCustomAttributes(typeof(StreamNameAttribute),
            true);
