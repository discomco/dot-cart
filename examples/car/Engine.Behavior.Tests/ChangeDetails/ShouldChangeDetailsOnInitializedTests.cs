...
{
    public ShouldChangeDetailsOnInitializedTests(ITestOutputHelper output, IoCTestContainer testEnv) : base(output, testEnv)
    {
    }
    ...
    public async Task ShouldRaiseOutputEvent()
    {
        ...
        var aggID = TestUtils.Schema.DocIDCtor();
