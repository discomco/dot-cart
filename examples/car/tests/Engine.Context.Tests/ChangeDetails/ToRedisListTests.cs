...
public class ToRedisListTests
    : ListProjectionTestsT<Context.ChangeDetails.Spoke, IRedisListDbInfo, Context.ChangeDetails.ToRedisList,
        Schema.EngineList, Contract.ChangeDetails.Payload, MetaB, Schema.EngineListID>
{
