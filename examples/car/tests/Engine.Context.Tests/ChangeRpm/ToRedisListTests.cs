...
public class ToRedisListTests
    : ListProjectionTestsT<Context.ChangeRpm.Spoke, IRedisListDbInfo, Context.ChangeRpm.ToRedisList,
        Schema.EngineList, Contract.ChangeRpm.Payload, MetaB, Schema.EngineListID
    >
{
